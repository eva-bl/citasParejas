        ...
        <aside class="hidden lg:flex fixed left-0 top-16 bottom-0 w-16 flex-col border-r border-pink-200/50 bg-white z-30">
            <div class="flex flex-col h-full p-2">
                ...
                <nav class="flex-1 space-y-1">
                    <a href="{{ route('dashboard') }}" 
                       class="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-pink-50 transition-all {{ request()->routeIs('dashboard') ? 'bg-pink-50 text-pink-600' : 'text-neutral-700' }}"
                       wire:navigate
                       title="Dashboard">
                    ...
                    @auth
                        @if(auth()->user()->hasCouple())
                            <a href="{{ route('plans.index') }}" 
                               class="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-pink-50 transition-all {{ request()->routeIs('plans.index') ? 'bg-pink-50 text-pink-600' : 'text-neutral-700' }}"
                               wire:navigate
                               title="Mis Planes">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('plans.calendar') }}" 
                               class="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-pink-50 transition-all {{ request()->routeIs('plans.calendar') ? 'bg-pink-50 text-pink-600' : 'text-neutral-700' }}"
                               wire:navigate
                               title="Calendario">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            ...
                            <a href="{{ route('plans.favorites') }}" 
                               class="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-pink-50 transition-all {{ request()->routeIs('plans.favorites') ? 'bg-pink-50 text-pink-600' : 'text-neutral-700' }}"
                               wire:navigate
                               title="Favoritos">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('statistics.index') }}" 
                               class="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-pink-50 transition-all {{ request()->routeIs('statistics.*') ? 'bg-pink-50 text-pink-600' : 'text-neutral-700' }}"
                               wire:navigate
                               title="Estadísticas">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('badges.index') }}" 
                               class="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-pink-50 transition-all {{ request()->routeIs('badges.*') ? 'bg-pink-50 text-pink-600' : 'text-neutral-700' }}"
                               wire:navigate
                               title="Insignias">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
