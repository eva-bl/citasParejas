        ...
        <form method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-6">
            ...
            <div class="relative">
                ...
                @if (Route::has('password.request'))
                    <flux:link class="absolute top-0 text-sm end-0 bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent" :href="route('password.request')" wire:navigate>
